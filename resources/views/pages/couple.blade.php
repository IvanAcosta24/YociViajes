        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="title__section">
                    ...
                    <p class="title">
                        Encuentra el hotel ideal para ti y tu pareja
                    </p>
                </div>
                <div class="bar"></div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="card">
                                            <p class="card-type"><i class="fas fa-male"></i><i class="fas fa-female"></i> <span>Pareja</span></p>
