...
@section('titulo','Hoteles | Luna de miel')
@section('contenido')
...
<div class="flayer">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <img src="img/flayers/honey.png" alt="">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="title__section">
                    ...
                    <p class="title">
                        Encuentra el mejor hotel para tu luna de miel
                    </p>
                </div>
                <div class="bar"></div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="card">
                                            <p class="card-type"><i class="fas fa-ring"></i>  <span>Luna de miel</span></p>
