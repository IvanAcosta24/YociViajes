...
@section('contenido')
    ...
    <div class="flayer">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img src="img/flayers/lux.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title__section">
                        ...
                        <p class="title">
                            Encuentra los hoteles de lujo que tenemos para ti
                        </p>
                    </div>
                    <div class="bar"></div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="card">
                                                <p class="card-type"><i class="far fa-gem"></i> <span>Lujo</span></p>
